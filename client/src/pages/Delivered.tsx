    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">היסטוריית עבודות שנמסרו ללקוחות</p>
        </div>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">עבודות שנמסרו</p>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <h3 className="text-lg font-medium">אין עבודות שנמסרו</h3>
              <p className="text-muted-foreground mt-1">עדיין לא נמסרו עבודות ללקוחות</p>
            </div>
          ) : (
            <Table>
              <TableHeader>
                    ...
                    >
                      ...
                      <TableCell className="text-muted-foreground">
                        <div className="flex items-center gap-1">
                          ...
                          {job.deliveredAt ? new Date(job.deliveredAt).toLocaleDateString("he-IL") : "-"}
                        </div>
                      </TableCell>
                      <TableCell className="font-bold text-green-600">
                        ₪{Number(job.totalJobPrice || job.quantity * Number(job.pricePerUnit) || 0).toLocaleString()}
                      </TableCell>
                    </TableRow>
                          ...
                          <div className="p-6 space-y-6">
                            ...
                            <div className="p-4 rounded-lg bg-teal-50 border border-teal-200">
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div>
                                  <p className="text-sm text-muted-foreground">תאריך מסירה</p>
                                  <p className="font-medium text-teal-600">
                                    {jobDetails.deliveredAt ? new Date(jobDetails.deliveredAt).toLocaleDateString("he-IL") : "-"}
                                  </p>
                                </div>
                                <div>
