...
export default function Login() {
  ...
  const validateFile = (file: File): string | null => {
    ...
    // Check for suspicious file names (potential path traversal)
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        setLoginError(data.error || "פרטי התחברות שגויים");
        return;
      }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50" dir="rtl">
      ...
      <header className="relative z-20 flex items-center justify-between p-4 md:p-6">
        ...
        {/* Small login button for existing users */}
                ...
                <form onSubmit={handleCustomerSignup} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Textarea
                        id="description"
                        placeholder="ספרו לנו מה אתם צריכים... (סוג המוצר, כמות, מפרט וכו')"
                  ...
                  {/* File Upload Section */}
                  <div className="space-y-2">
                    <Label>קבצי עבודה</Label>
                    <div 
                      className="border-2 border-dashed border-gray-200 rounded-lg p-4 text-center hover:border-blue-400 transition-colors cursor-pointer"
                    ...
                    {uploadedFiles.length > 0 && (
                      <div className="space-y-2 mt-3">
                        ...
                        <p className="text-xs text-gray-500 text-center">
                          {uploadedFiles.length} / {MAX_FILES} קבצים
                        </p>
                      </div>
                    )}
                    ...
                    <div className="flex items-start gap-2 p-2 bg-amber-50 rounded-lg text-xs text-amber-700">
                      ...
                      <p>הקבצים יעברו בדיקת אבטחה ווולידציה לפני העיבוד</p>
                    </div>
                  </div>
                  ...
                  <p className="text-xs text-center text-muted-foreground pt-2">
                    בשליחת הטופס אתם מסכימים לתנאי השימוש ומדיניות הפרטיות
                  </p>
                </form>
              </CardContent>
            </Card>
      ...
      <footer className="relative z-10 text-center py-6 text-sm text-muted-foreground">
        <p>© 2026 QuoteFlow. כל הזכויות שמורות.</p>
      </footer>
    </div>
  );
}
